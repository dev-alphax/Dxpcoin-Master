...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"light blue\">" + qVolume + " DXP" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " DXP" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " DXP");
    }
