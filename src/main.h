...
#define FOUNDATION "DreZWS86H5skxTZZVbMw7mnPZXpwaxmvd4"
//#define FOUNDATION2 ""
#define FOUNDATION_TEST "DreZWS86H5skxTZZVbMw7mnPZXpwaxmvd4"
...
public:
    ...
    {
        // dxpcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // dxpcoin: get transaction coin age
...
public:
    ...
    // dxpcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // dxpcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // dxpcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // dxpcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // dxpcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // dxpcoin: block index flags
    enum  
    {
